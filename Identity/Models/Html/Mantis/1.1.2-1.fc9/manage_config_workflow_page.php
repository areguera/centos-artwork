...
# along with Mantis.  If not, see <http://www.gnu.org/licenses/>.
	...
	function section_begin( $p_section_name ) {
		...
		echo '<tr class="title"><td class="form-title" colspan="' . ( count( $t_enum_status ) + 2 ) . '">'
			. strtoupper( $p_section_name ) . '</td></tr>' . "\n";
		echo '<tr class="title"><td class="form-title" width="30%" rowspan="2">' . lang_get( 'current_status' ) . '</td>';
	...
	function threshold_begin( $p_section_name ) {
		echo '<table class="width100">';
		echo '<tr class="title"><td class="form-title" colspan="3">' . strtoupper( $p_section_name ) . '</td></tr>' . "\n";
		echo '<tr class="title"><td class="form-title" width="30%">' . lang_get( 'threshold' ) . '</td>';
