...
class Autoresponse(GUIBase):
    ...
    def GetConfigInfo(self, mlist, category, subcat=None):
        ...
        return [
            '<p>' + _('Auto-responder characteristics.') + '</p>' +
	    '<p>' + _('In the text fields below, string interpolation is performed with the following key/value substitutions:') + 
	    '</p>' + 
	    '''<ul>
    <li><strong>listname</strong> - <em>''' + _('gets the name of the mailing list') + '''</em></li>
    <li><strong>listurl</strong> - <em>''' + _("gets the list's listinfo URL") + '''</em></li>
    <li><strong>requestemail</strong> - <em>''' + _("gets the list's -request address") + '''</em></li>
    <li><strong>owneremail</strong> - <em>''' + _("gets the list's -owner address") + '''</em></li>
</ul>

<p>''' + _('For each text field, you can either enter the text directly into the text box, or you can specify a file on your local system to upload as the text.') + '''</p>''',
