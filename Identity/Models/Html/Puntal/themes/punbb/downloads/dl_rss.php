...
<channel>
	...
	<link><?php tpl::url('pt_portal_url') ?></link> 
	<description><?php tpl::headTitlePage()?></description>		
	<language><?php tpl::lang('lang_iso_code') ?></language>
	<generator>Puntal 2</generator>
<?php download::downloadListPopularDlRSS() ?>
<?php download::downloadListLastDlRSS() ?>
</channel>
</rss>