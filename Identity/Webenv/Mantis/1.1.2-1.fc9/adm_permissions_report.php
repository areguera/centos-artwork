...
# along with Mantis.  If not, see <http://www.gnu.org/licenses/>.
	...
	function get_section_begin( $p_section_name ) {
		...
		$t_output .= '<tr class="title"><td class="form-title" colspan="' . ( count( $t_access_levels ) + 1 ) . '">' . strtoupper( $p_section_name ) . '</td></tr>' . "\n";
		$t_output .= '<tr class="title"><td class="form-title" width="40%">' . lang_get( 'perm_rpt_capability' ) . '</td>';
