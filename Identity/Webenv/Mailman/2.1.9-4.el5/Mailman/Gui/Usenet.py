    ...
    def GetConfigInfo(self, mlist, category, subcat=None):
	    ...
	    '</p>',
            ...
            ('nntp_host', mm_cfg.String, WIDTH, 0,
             ...
             optionally of the format name:port, where port is a port number.</p>

             <p>The news server is not part of Mailman proper.  You have to
            ...
            ('news_moderation', mm_cfg.Radio,
             ...
             set this option to <em>None</em>.</p>
             ...
             or to the mailing list membership.</p>

             <p>Note that if the message has an <tt>Approved</tt> header
             with the list's administrative password in it, this hold test
             will be bypassed, allowing privileged posters to send messages
             directly to the list and the newsgroup.</p>
