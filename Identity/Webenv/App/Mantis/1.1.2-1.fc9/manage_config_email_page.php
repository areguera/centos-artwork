 ...
 */
	...
	function get_section_begin_for_email( $p_section_name ) {
		...
		echo '<tr class="title"><td class="form-title" colspan="' . ( count( $t_access_levels ) + 7 ) . '">' . strtoupper( $p_section_name ) . '</td></tr>' . "\n";
		echo '<tr class="title"><td class="form-title" width="30%" rowspan="2">' . lang_get( 'message' ) . '</td>';
