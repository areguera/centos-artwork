	    ...
	    '</p>',
	     ...
	     '<p>' +
            ...
            ('topics_bodylines_limit', mm_cfg.Number, 5, 0,
             ...
             lines will be scanned (i.e. only the <tt>Keywords:</tt> and
             <tt>Subject:</tt> headers will be scanned).  By setting this
            ...
            ('topics', mm_cfg.Topics, 0, 0,
             ...
             <tt>Keywords:</tt> and <tt>Subject:</tt> message headers.
             Note that the first few lines of the body of the message can also
             contain a <tt>Keywords:</tt> and <tt>Subject:</tt>
