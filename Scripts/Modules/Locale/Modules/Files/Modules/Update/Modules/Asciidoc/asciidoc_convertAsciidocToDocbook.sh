...
# Convert asciicoc files into docbook files using asciidoc command's
...
# is an article or a manpage). This information is stored in
# render.conf file, in the same directory of asciidoc file. Both
