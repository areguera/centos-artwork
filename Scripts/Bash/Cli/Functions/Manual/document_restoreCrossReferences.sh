#!/bin/bash
#
# document_restoreCrossReferences.sh -- This function looks inside
...
# document_deleteCrossReferences function. The
# document_restoreCrossReferences function relays in the removed message
# format produced by document_deleteCrossReferences function, in order
