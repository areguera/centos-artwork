...
function texinfo_makeSeeAlso {
    ...
    TMARK_PATTERN="^@c -- <\[${TCAR_CLI_NAME}\(SeeAlso(,(itemize|enumerate|menu))?\)$"
    ...
    for TMARK in $TMARKS;do
        ...
        # processed.
        LIST_TYPE_PATTERN="^@c -- <\[${TCAR_CLI_NAME}\(SeeAlso${LIST_PROP}\)$"
        ...
        LIST_DEF="@c -- <[${TCAR_CLI_NAME}(SeeAlso${LIST_PROP})\n@${LIST_TYPE}\n${LIST_ENTRIES}@end ${LIST_TYPE}\n@c -- ]>"
