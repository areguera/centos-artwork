...
function prepare_updateManuals {
    ...
    ${CLI_BASEDIR}/${CLI_NAME}.sh render trunk/Documentation/Manuals/Docbook/Tcar-ug 
    ${CLI_BASEDIR}/${CLI_NAME}.sh help   trunk/Documentation/Manuals/Texinfo/Tcar-fs --update
