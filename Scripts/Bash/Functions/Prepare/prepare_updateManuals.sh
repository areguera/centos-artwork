...
function prepare_updateManuals {
    ...
    # Define documentation manuals key names.
    local MANUALS_NAMES="Tcar-ug Tcar-fs"

    # Define relative paths of design models and images used by
    # documentation manuals.
    local MANUALS_IMAGES=Identity/Images/Manuals
    local MANUALS_MODELS=Identity/Models/Manuals

    # Verify related design models and images used by documentation manuals.
    for DIR in $(echo "$MANUALS_IMAGES $MANUALS_MODELS");do
    ...
    # Build output files related to key documentation manuals.
    ${CLI_BASEDIR}/${CLI_NAME}.sh render trunk/${MANUALS_IMAGES} --dont-commit-changes
