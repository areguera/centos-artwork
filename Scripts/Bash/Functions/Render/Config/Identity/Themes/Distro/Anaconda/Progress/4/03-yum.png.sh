...
function render_loadConfig {
    ...
    DST[1]="`gettext "The recommended way to install or upgrade CentOS is to use <flowSpan style=\\\"font-weight:bold\\\">Yum</flowSpan> (Yellow Dog Updater, Modified)"`"

    DST[2]="`gettext "See the guide entitled: \\\"Managing Software with Yum\\\" at the documentation link below."`"

    DST[3]=" `gettext "<flowSpan style=\\\"font-weight:bold\\\">YumEx</flowSpan>, a graphical front end for Yum, is also available from the CentOS Extras repository."`"

    DST[4]=''
    DST[5]=''
    DST[6]=''

    DST[7]="=URL_WIKI==MAJOR_RELEASE=/"
