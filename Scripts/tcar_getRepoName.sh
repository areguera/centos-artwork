...
# Standardize files and directories name convection inside the working
# copy of CentOS Artwork Repository. As convection, regular files are
# written in lower-case and directories are written capitalized.  Use
# this function to sanitate the name of regular files and directories
# on paths you work with.
