#!/bin/bash
#
# help_texinfo_updateMenu.sh -- This function updates menu lines inside
...
function help_texinfo_updateMenu {
    ...
    case $ACTION in
        ...
        'update-entry' | * )
            ...
            # behaivour if no argument is passed to help_texinfo_updateMenu
            # function.
            MENU="$MENU
            $MENULINE"
            ;;
