...
<rss version="2.0">
	<channel>
		<title><?php tpl::headTitlePage() ?> - <?php tpl::lang('News') ?></title> 
		<link><?php news::newsUrl() ?></link>
		...
		<item>
			...
			<link><?php news::topicUrl() ?></link> 
			<description><![CDATA[<?php news::rssMessage() ?>]]></description> 
			<pubDate><?php news::rssDate() ?></pubDate>
		</item>
		<?php endwhile; ?>
	</channel>
