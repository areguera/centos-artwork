...
<!-- Title -->
<tr class="title">
	<td class="form-title" colspan="3"><?php echo lang_get( 'updating_bug_simple_title' ) ?></td>
...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td colspan="5">
		<input <?php echo helper_get_tab_index() ?> type="text" name="summary" size="80" maxlength="128" value="<?php echo $t_bug->summary ?>" />
	</td>
</tr>
