...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		<input <?php echo helper_get_tab_index() ?> type="text" name="summary" size="80" maxlength="128" value="<?php echo $f_summary ?>" />
	</td>
</tr>
...
?>
		<label title="<?php echo lang_get( 'public' );?>"><input <?php echo helper_get_tab_index() ?> type="radio" name="view_state" value="<?php echo VS_PUBLIC ?>" <?php check_checked( $f_view_state, VS_PUBLIC ) ?> /> <?php echo lang_get( 'public' ) ?></label>
		<label title="<?php echo lang_get( 'private' ); ?>"><input <?php echo helper_get_tab_index() ?> type="radio" name="view_state" value="<?php echo VS_PRIVATE ?>" <?php check_checked( $f_view_state, VS_PRIVATE ) ?> /> <?php echo lang_get( 'private' ) ?></label>
<?php
	} else {
...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		<label title="<?php echo lang_get( 'check_report_more_bugs' ); ?>"><input <?php echo helper_get_tab_index() ?> type="checkbox" name="report_stay" <?php check_checked( $f_report_stay ) ?> /> (<?php echo lang_get( 'check_report_more_bugs' ) ?>)</label>
	</td>
</tr>
